            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6 md:p-8">
              ...
              <div className="mt-8 rounded-xl border border-white/10 bg-slate-900/60 p-5">
                ...
                <div className="mt-5 flex flex-wrap gap-3">
                  <button className="rounded-lg bg-white px-4 py-2 text-sm font-medium text-slate-900 transition hover:bg-slate-200">
                    Join Now
                  </button>
                  <button className="rounded-lg border border-white/20 px-4 py-2 text-sm font-medium text-white transition hover:bg-white/10">
                    Copy Room Link
                  </button>
                </div>
              </div>
